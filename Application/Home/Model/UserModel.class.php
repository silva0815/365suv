...
//        array('publish_at','getTime',self::MODEL_INSERT,'callback'),
//        array('edit_at','getTime',self::MODEL_BOTH,'callback'),
//        array('login_at','time',self::MODEL_UPDATE,'callback'),
//        array('create_at','time',self::MODEL_INSERT,'callback'),
